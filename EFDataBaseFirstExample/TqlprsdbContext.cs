...
public partial class TqlprsdbContext : DbContext
{
    ...
    public virtual DbSet<Product> Products { get; set; } //these dont have to virtual but they are 
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) 
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC0767715C39");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Requests__3214EC075122999F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Requestl__3214EC073A9EB3C0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC07F8EAB2E6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Vendors__3214EC0718EF14C8");
